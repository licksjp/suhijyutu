...
'2024.07.28_Ver160_20240728(Final)
'******************************************************************************************************************
'公開バージョン番号
Version$ = "Ver:1.6.0_20240728(Final)"
'******************************************************************************************************************
'画像ファイル保存フォルダ
'******************************************************************************************************************
'Gazo Folder Japan
...
select case No
'選択肢　1 - 2に変更
'case 0 1.ビジネスの相性占い => 2.トップ画面に戻る
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:sp_put 1,(X,Y+150),1,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                                                               ":color rgb(0,0,0):locate 1,15:print "2.トップ画面に戻るを選択":goto Kabara_Aishou_Top2:
'選択肢　2 - 3に変更
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_put 0,(X,Y),0,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                       ":color rgb(0,0,0):locate 1,15:print "1.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
'リリース時 case 2コメント解除
case else:
goto Kabara_Aishou_Top2:
end select
...
select case No
case 0:
No=1:sp_on 0,0:sp_on 1,1:sp_on 2,0:sp_put 0,(X,Y+150),1,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print"                                       ":color rgb(0,0,0):locate 1,15:print "2.トップ画面に戻るを選択":goto Kabara_Aishou_Top2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_put 1,(X,Y),0,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                      ":color rgb(0,0,0):locate 1,15:print "1.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
end select
endif
endif
'**************************************************************************************************************************
