...
'***********************************************************
'名前フォルダ　buf_name1$:名前の姓
'名前フォルダ　buf_name2$:名前の名
...
'Option change 2 - 3
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:locate 1,15:print "                                       ":locate 1,15:print "3. Select return to the top screen":locate 1,16:goto Kabara_Aishou_Top2:
...
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:pause 200:locate 1,19:print "                                                                               ":color rgb(0,0,0):locate 1,19:print "2.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
'選択肢　2 - 3に変更
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:locate 1,19:print "                                       ":color rgb(0,0,0):locate 1,19:print "3.トップ画面に戻るを選択":goto Kabara_Aishou_Top2:
'リリース時 case 2コメント解除
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:locate 1,19:print "                                      ":color rgb(0,0,0):locate 1,19:print "1.男女2人の相性占いを選択":goto Kabara_Aishou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
...
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200::locate 1,19:print"                                       ":color rgb(0,0,0):locate 1,19:print "1.男女2人の相性占いを選択":goto Kabara_Aishou_Top2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:pause 200:locate 1,19:print "                                      ":color rgb(0,0,0):locate 1,19:print "2.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
...
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:pause 200:cls:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                                                               ":locate 1,19:color rgb(0,0,0):print "2.男女2人の相性を選択":goto Danjyo_Aisyou_Top2:
'選択肢　2 - 3に変更
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:cls:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                       ":locate 1,19:color rgb(0,0,0):print "3.トップ画面に戻るを選択":goto Danjyo_Aisyou_Top2:
'リリース時 case 2コメント解除
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:cls:gosub Danjyo_Aisyou_TopScreen_Recheck:locate 1,19:print "                                      ":locate 1,19:color rgb(0,0,0):print "1.自分と異性の相性占い(未実装)を選択"::goto Danjyo_Aisyou_Top2:
case else:
...
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:cls:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                       ":locate 1,19:color rgb(0,0,0):print "3.トップ画面に戻るを選択":goto Danjyo_Aisyou_Top2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:cls:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print"                                       ":locate 1,19:color rgb(0,0,0):print "1.自分と異性の相性占いを選択":goto Danjyo_Aisyou_Top2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:pause 200:cls:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                      ":locate 1,19:color rgb(0,0,0):print "2.男女2人の相性占いを選択":goto Danjyo_Aisyou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
