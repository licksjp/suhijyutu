...
case 3:
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:gosub Kabara_TopScreen_Recheck:pause 200:color rgb(0,0,0): locate 1,18:print"                                      ":locate 1,18:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 0:
...
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:gosub Kabara_TopScreen_Recheck:pause 200:color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,18:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),0,0:beep:gosub Kabara_TopScreen_Recheck:pause 200:color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,18:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
case 3:
...
'日本の端末の時  ここから
'***************************************************************************************************\
locate 0,5:color rgb(255,255,255)
'****************************************************************************************************
'WUXG(1920x1200)の時ここから
'****************************************************************************************************
print "番号を選んでください"
locate 1,5:font FONT
...
'女性の名前を入力する　ここから
'**********************************************************
buffer_Kabara_female_name$ = female_nname$
'**********************************************************
'女性の名前を入力する　ここまで
'**********************************************************
’***********************************************************
...
'女性の数秘ナンバーを求める　ここから
'*************************************************************
Kabara_female_Number = Kabara_female_Num(buf_female_year,buf_female_month,buf_female_day)
'*************************************************************
'女性の数秘ナンバーを求める　ここまで
'*************************************************************
'********************************************************
