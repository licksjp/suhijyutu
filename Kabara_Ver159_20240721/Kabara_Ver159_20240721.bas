...
'2024.03.18:Ver141_20240317
'2024.03.24:Ver142_20240324
'2024.03.31:Ver143_20240331
'*****************************************************************************************************************
'AC.2024.04.(April)
'2024.04.07:Ver144_20240407
'2024.04.14:Ver145_20240414
'2024.04.21:Ver146_20240421
'2024.04.28:Ver147_20240428
'*****************************************************************************************************************
'AC.2024.05(May)
'2024.05.05:Ver148_20240505
'2024.05.12:Ver149_20240512
'2024.05.19:Ver150_20240519
'2024.05.26_Ver151_20240526
'******************************************************************************************************************
'AC 2024.06(June)
'2024.06.02_Ver152_20240602
'2024.06.09_Ver153_20240609
'2024.06.16_Ver154_20240616
'2024.06.23_Ver155_20240623
'2024.06.30_Ver156_20240630
'******************************************************************************************************************
'AC 2024.07(July)
'2024.07.07_Ver157_20240707
'2024.07.14_Ver158_20240714
'2024.07.21_Ver159_20240721
'******************************************************************************************************************
'公開バージョン番号
Version$ = "Ver:1.5.9_20240721"
'******************************************************************************************************************
'画像ファイル保存フォルダ
'******************************************************************************************************************
'Gazo Folder Japan
...
b=0:c=0:n=0:count=0
'**********************************************************************************************
'dim buffer_List$(11,1):バーズアイグリット 登録リスト
'**********************************************************************************************
...
'dim buffer_List$(11,1)
'***********************************************************
'名前フォルダ　buf_name1$(10):名前の姓　10文字
'名前フォルダ　buf_name2$(10):名前の名 10文字
...
'部下の数秘ナンバー
'File 読み込み
'部下のデータ(Kabara_Business_Aisyou.csv)を読み込んで配列に代入する
'1.ビジネスの相性占い
'******************************************************************
...
'2.男女の相性占い
'file 読み込み
'部下のデーター(Kabara_bitween_sexes_Aisyou.csv)を読み込んで配列にデーターを
'代入する。
'代入する配列(Buffer_Bitween_sexes_Aisyou$(j,i))
'**************************************************************
...
gload Gazo$ + "Selection.png",1,70,500
'10:7
gload Gazo$ + "Selection.png",1,540,300
'11:8
gload Gazo$ + "Selection.png",1,540,400
'12:9
gload Gazo$ + "Selection.png",1,540,500
'13:0
...
'9(10):9
sp_def 10,(540,300),32,32
'6(11):6
sp_def 11,(540,400),32,32
'9(12):3
sp_def 12,(540,500),32,32
...
'**********************************************************************************************
'10:7
'gload Gazo$ + "Selection.png",1,430,300
'11:8
'gload Gazo$ + "Selection.png",1,430,420
'12:9
'gload Gazo$ + "Selection.png",1,430,500
'**********************************************************************************************
'9
sp_def 10,(540,300),32,32
'6
...
sp_put 3,(5,600),3,0
'********************************************************************************************************
'選択肢の● ここまで 1920x1260    ここまで
'********************************************************************************************************
'********************************************************************************************************
'sp_put 1920x1260 ここから
'*********************************************************************************************************
'1. 下
'1,7
sp_put 4,(130,300),7,0
'2,4
sp_put 5,(130,400),4,0
'3,1
sp_put 6,(130,500),1,0
'2.中央
'4,8
sp_put 7,(340,300),8,0
'5,5
sp_put 8,(340,400),5,0
'6,2
sp_put 9,(340,500),2,0
'上
'7,9
sp_put 10,(540,300),9,0
'8,6
sp_put 11,(540,400),6,0
'9,3
sp_put 12,(540,500),3,0
'********************************************************************************************************
'0,13
...
'ここから始まる
'1.Main_Top:
'Label:Main_Top: → Kabara_TopScreen:,メイン画面(Main_Top:)　→ 数秘術トップ画面(Kabara_TopScreen:)
'***********************************************************************************************
Main_Top:
'************************************************************************************************
'再生を止める
...
case 0:
'1
No = 1:sp_on 0,0:sp_on 1,1:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),1,0:count = count + 1:beep:pause 200:gosub TopScreenRecheck:locate 1,19:print "                          ":locate 1,19:color rgb(0,0,0):print "2.設 定を選択":count = count + 1:goto Main_Screen_Select:
case 1:
'2
No = 2:sp_on 1,0:sp_on 2,1:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:count = count + 1:pause 200:gosub TopScreenRecheck:locate 1,19:print "                                 ":locate 1,19:color rgb(0,0,0):print "3.ヘルプを選択":count = count + 1:goto Main_Screen_Select:
case 2:
'3
No=3:sp_on 3,1:sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_put 3,(X,Y+320),3,0:beep:count = count + 1:pause 200:gosub TopScreenRecheck:locate 1,19:print "                            ":locate 1,19:color rgb(0,0,0):print "4.(プログラムを)終了するを選択":count = count + 1:goto Main_Screen_Select:
case 3:
'0
...
'************************************************************************************************
'************************************************************************************************
'1: sp_put 6,(130,500),1,0
'*************************************************************************************************
sp_put 6,(130,500),1,0
'*************************************************************************************************
'2:sp_put　9,(340,500),10,0
'*************************************************************************************************
sp_put 9,(340,500),10,0
'*************************************************************************************************
'3:sp_put 12,(540,500),3,0
'*************************************************************************************************
sp_put 12,(540,500),3,0
'*************************************************************************************************
'4:sp_put 5,(130,400),4,0
'*************************************************************************************************
sp_put 5,(130,400),4,0
'*************************************************************************************************
'5:sp_put 8,(340,340),5,0
'*************************************************************************************************
sp_put 8,(340,400),5,0
'*************************************************************************************************
'6:sp_put 11,(540,400),6,0
'*************************************************************************************************
sp_put 11,(540,400),6,0
'*************************************************************************************************
'7:sp_put 4,(130,300),7,0
'*************************************************************************************************
sp_put 4,(130,300),7,0
'**************************************************************************************************
'8:sp_put 7,(340,300),8,0
'***************************************************************************************************
sp_put 7,(340,300),8,0
'*************************************************************************************************
'9:sp_put　10,(540,300),9,0
'************************************************************************************************
sp_put 10,(540,300),9,0
'*************************************************************************************************
'0:sp_put 13,(340,600),13,0
'************************************************************************************************
sp_put 13,(340,600),13,0
'************************************************************************************************
'OK:sp_put 14,(540,600),14,0
'***********************************************************************************************
sp_put 14,(540,600),14,0
'*************************************************************************************************
locate 0,1
...
'3ボタンから 6に移動
case 3:
No=6:sp_on 11,1:sp_on 12,0:beep
pause 200:goto Input_Seireki2:
'6ボタンから ９に移動
case 6:
...
'sp_on 7,1:7
case 0:
No=2:sp_on 9,1:sp_on 13,0:beep
pause 200:goto Input_Seireki2:
'上  0ボタンから2ボタン　ここまで
'2から５になる 上
case 2:
...
'9から６に下げる
case 9:
No=6:sp_on 10,0:sp_on 11,1:beep
pause 200:goto Input_Seireki2:
'6から３に下げる
case 6:
...
'十字キー　ここまで
'*************************************************************************************************************************
'WXGA(Wide XGA)　1280 x 800 ここまで
'*************************************************************************************************************************
else
'************************************************************************************************
'2.WUXGAの時1920x1280の時 ここから
'************************************************************************************************
'************************************************************************************************
'1.十字キー上ここから
'************************************************************************************************
...
case 4:
No=1:sp_on 6,1:sp_on 5,0:beep
sp_put 6,(130,500),1,0:pause 200:goto Input_Seireki2:
case 1:
beep:pause 200:goto Input_Seireki2:
end select
endif
...
'1.WXGA(1260x800)の時
'****************************************************************************************************
gload Gazo$ + Gazo_WXGA$ + "ResultScreen_918x680_20240309.png",0,0,0
'****************************************************************************************************
'1.WUXGA(1260x800)の時
'****************************************************************************************************
else
...
'1.数秘ナンバー 2
'****************************************************************************************************
play Voice$ + "Result_Kabara_2_20230607.mp3"
'****************************************************************************************************
'1.数秘ナンバー 2
'****************************************************************************************************
case 3:
...
'1.数秘ナンバー 5
'****************************************************************************************************
play Voice$ + "Result_Kabara_5_20230607.mp3"
'****************************************************************************************************
'1.数秘ナンバー 5
'****************************************************************************************************
case 6:
...
select case No
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_put 1,(5,Y + 120),1,0:count = count + 1:beep:pause 200:gosub Help_Top_ReCheck:color rgb(0,0,0):locate 1,19:print "                                      ":locate 1,19:print"2.バージョンを選択":goto Help_Select:
case 1:
...
select case No
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_put 1,(5,400),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print"2.バージョンを選択":goto Help_Select:
case 1:
...
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(5,Y+120),1,0:count=count+1:beep:pause 200:gosub Help_Top_ReCheck:color rgb(0,0,0):locate 1,15:print "                                        ":locate 1,19:print "2.バージョンを選択":goto Help_Select:
case 3:
...
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "1.ルールの説明を選択":goto Help_Select:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(5,400),1,0:beep:pause 200:locate 1,15:print "                                        ":locate 1,15:print "2.バージョンを選択":goto Help_Select:
case 3:
No=2:sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(5,500),2,0:beep:pause 200:locate 1,15:print "                                              ":locate 1,15:print "3.参考文献を選択":goto Help_Select:
end select
endif
...
select case No
case 0:
sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,0:pause 200:goto Suhi_Rule_explainTop: 'Suhi_Rule:
case 1:
...
'****************************************************************************************************
'****************************************************************************************************
'WXGA 1280 x 800 の時　ここから
'****************************************************************************************************
if ((size(0) <= 1280) and (size(1) <= 800))  then
'****************************************************************************************************
'WXGA 1280x800 の時　ここから
'****************************************************************************************************
locate 1,19:color RGB(0,0,0)
print "1.数秘術のやり方"
'****************************************************************************************************
'WXGA 1280 x 800 の時　ここまで
'****************************************************************************************************
'****************************************************************************************************
'WXGA 1280 x 800 の時　ここまで
'****************************************************************************************************
...
if ((size(0) <= 1280) and (size(1) <= 800)) then
'*******************************************************************************************************
'WXGA 1200x 800 ここから 日本語
'*******************************************************************************************************
if ((y = 1) or (key$ = chr$(31))) then
select case No
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_put 1,(x,Y+120),1,0:beep:pause 200:gosub SuhiRule_Recheck:count=count+1:color rgb(0,0,0):locate 1,19:print "                                      ":locate 1,19:print"2.バーズアイグリットの説明を選択":goto Suhi_Rule_explainTop2:
case 1:
No=2:sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:pause 200:gosub SuhiRule_Recheck:count=count+1:locate 1,19:color rgb(0,0,0):print "                                      ":locate 1,19:print "3.トップ画面に戻るを選択":goto Suhi_Rule_explainTop2:
case 2:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:pause 200:gosub SuhiRule_Recheck:count=count+1:locate 1,19:color rgb(0,0,0):print "                                              ":locate 1,19:print "1.数秘術のやり方を選択":goto Suhi_Rule_explainTop2:
end select
endif
'ジョイパッド：上  (y=-1) 、カーソル上 (key$=chr$(30))
if ((y = -1) or (key$ = chr$(30))) then
select case No
case 0:
No=2:sp_on 1,0:sp_on 0,0:sp_on 2,1:sp_on 0,0:sp_put 2,(5,Y+220),0,0:beep:pause 200:gosub SuhiRule_Recheck:count=count+1:locate 1,19:color rgb(0,0,0):print "                                      ":locate 1,19:print "1.数秘術のやり方を選択":goto Suhi_Rule_explainTop2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,Y+20),1,0:beep:pause 200:gosub SuhiRule_Recheck::count=count+1:locate 1,19:color rgb(0,0,0):print "                                        ":locate 1,19:print "2.バーズアイグリットの説明を選択":goto Suhi_Rule_explainTop2:
case 2:
No=1:sp_on 1,1:sp_on 1,0:sp_on 0,0:sp_on 2,0:sp_put 1,(5,Y+120),2,0:beep:pause 200:gosub SuhiRule_Recheck:count=count+1:locate 1,19:color rgb(0,0,0):print "                                              ":locate 1,19:print "3.トップ画面に行くを選択":goto Suhi_Rule_explainTop2:
end select
endif
'*******************************************************************************************************
...
select case No
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_put 1,(5,400),1,0:beep:pause 200:gosub SuhiRule_Recheck2:locate 1,15:color RGB(0,0,0):print "                                      ":locate 1,15:print"2.バーズアイグリットの説明を選択":goto Suhi_Rule_explainTop2:
case 1:
No=2:sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(5,500),2,0:beep:pause 200:gosub SuhiRule_Recheck2:locate 1,15:color rgb(0,0,0):print "                                      ":locate 1,15:print "3.トップ画面に戻るを選択":goto Suhi_Rule_explainTop2:
case 2:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:beep:pause 200:GOSUB SuhiRule_Recheck2:locate 1,15:color rgb(0,0,0):print "                                              ":locate 1,15:print "1.数秘術のやり方を選択":goto Suhi_Rule_explainTop2:
end select
endif
'ジョイパッド：上  (y=-1) 、カーソル上 (key$=chr$(30))
if ((y = -1) or (key$ = chr$(30))) then
select case No
case 0:
No=2:sp_on 1,0:sp_on 0,0:sp_on 2,1:sp_on 3,0:sp_put 2,(5,500),2,0:beep:pause 200:gosub SuhiRule_Recheck2:locate 1,15:color rgb(0,0,0):print "                                      ":locate 1,15:print "3.トップ画面に戻るを選択":goto Suhi_Rule_explainTop2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:beep:pause 200:gosub SuhiRule_Recheck2:locate 1,15:color rgb(0,0,0):print "                                        ":locate 1,15:print "1.数秘術のやり方を選択":goto Suhi_Rule_explainTop2:
case 2:
No=1:sp_on 2,0:sp_on 1,1:sp_on 0,0:sp_on 3,0:sp_put 1,(5,400),1,0:beep:pause 200:gosub SuhiRule_Recheck2:locate 1,15:color rgb(0,0,0):print "                                              ":locate 1,15:print "2.バーズアイグリットの説明を選択":goto Suhi_Rule_explainTop2:
end select
endif
'******************************************************************************************************
'1920x 1260　ここまで
...
select case No
case 0:
sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,0:pause 200:goto Suhi_Rule:  '1.数秘ルールの説明
case 1:
sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,0:pause 200:goto BirdsEyeGrid_Explain1:  '2.バーズアイグリットの説明
'3:Top画面に行く
case 2:
...
'●.初期設定
cls 3:font FONT:bg = 0:key$ = "":bg2 = 0
play "":'音を停める
'バーズアイグリット基本チャートを表示　　ここから
if ex_info$(1) <> "JP" then
'英語ファイル
...
select case No
case 2:
No=3:sp_on 3,1:sp_on 1,0:sp_on 2,0:sp_on 0,0:sp_put 3,(X,Y+320),3,0:beep:pause 200:locate 1,15:print "                                    ":locate 1,15:print "4.Return to Top Screen":goto Kabara_TopScreen2:
case 3:
...
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "2.Select Bird's Eye Grid":goto Kabara_TopScreen2:
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:pause 200:locate 1,15:print "                                              ":locate 1,15:print"3.Select Compatibility Divination":goto Kabara_TopScreen2:
end select
endif
'*****************************************************************************************************
'1.英語パート ここまで
...
if ((size(0) <= 1280) and (size(1) <= 800)) then
'******************************************************************************************************
'1:1280 x 800 2.日本語 ここから
'*****************************************************************************************************
'*****************************************************************************************************
'y=1:カーソル下,chr$(31)キーボードカーソル下
'*****************************************************************************************************
if ((y = 1) or (key$ = chr$(31))) then
select case No
case 2:
No=3:sp_on 3,1:sp_on 1,0:sp_on 2,0:sp_on 0,0:sp_put 3,(X,Y+320),3,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                    ":locate 1,18:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
case 3:
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0): locate 1,18:print"                                      ":locate 1,18:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),1,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,18:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                              ":locate 1,18:print"3.相性占いを選択":goto Kabara_TopScreen2:
end select
endif
'カーソル　上  or  ジョイパッド　上(下から上)
if ((y = -1) or (key$ = chr$(30))) then
select case No
case 0:
No=3:sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,1:sp_put 3,(X,Y+320),3,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,18:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,18:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),1,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,18:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
case 3:
No=2:sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                       ":locate 1,18:print "3.相性占いを選択":goto Kabara_TopScreen2:
end select
endif
'*****************************************************************************************************
'1:1280 x800(Wide XGA) ここまで
'*****************************************************************************************************
else
'******************************************************************************************************
'2:1920x1280 ここから
...
'******************************************************************************************************
'******************************************************************************************************
'y=1:ジョイパッド下 , chr$(31):カーソル下 Case No Min:0 Max:3
'******************************************************************************************************
if ((y = 1) or (key$ = chr$(31))) then
'******************************************************************************************************
'〇.ここからカーソルを下にやる処理。
'・1.スタート:1.数秘術占い
'・1.数秘術占い → 2.バーズアイグリット case 0 No:0 → No=1
'・2.2.バーズアイグッリット → 3.相性占い case 1 No:1 → No=2
'・3.3.相性占い → 4.トップ画面に戻るを選択 case 2 No:2 → No=3
'・4.トップ画面に戻るを選択 → 1.数秘術占い case 3 No:3 → No=0
'******************************************************************************************************
select case No
'******************************************************************************************************
case 0:
'******************************************************************************************************
'下 選択肢 1:1.数秘術占い → 2.バーズアイグリット:(2)　 → 2  ON (1) 他　OFF (0,2,3):〇
'case 0:1.数秘術占い→  2.バーズアイグリット　　→  No=0  →    No=1
'******************************************************************************************************
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,400),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
'*****************************************************************************************************
'1.数秘術占い → 2.バーズアイグッリット
'*****************************************************************************************************
case 1:
'*****************************************************************************************************
'下 選択肢:2(1):2.バーズアイグッリット → 3 (2):3.相性占い :ON (2) 他OFF (0,1,3):〇
'case 1:バーズアイグリット　→ 2.相性占い  →  No=1  →   No=2
'*****************************************************************************************************
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(X,500),2,0:beep:pause 200:locate 1,15:print "                                              ":locate 1,15:print "3.相性占いを選択":goto Kabara_TopScreen2:
'*****************************************************************************************************
'2.バーズアイグッリット →　3.相性占い
'*****************************************************************************************************
case 2:
'*****************************************************************************************************
'下 選択肢 3:3.相性占い → 4  4:4.トップ画面に戻るを選択: ON(3) ,他 OFF(0,1,2):〇　
'case 2:相性占い →  3.トップ画面に戻る　　→  No =  2  →  No = 3
'*****************************************************************************************************
No=3:sp_on 3,1:sp_on 1,0:sp_on 2,0:sp_on 0,0:sp_put 3,(X,600),3,0:beep:pause 200:locate 1,15:print "                                    ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
'*****************************************************************************************************
'3.相性占い → 4.トップ画面に戻るを選択
'*****************************************************************************************************
case 3:
'*****************************************************************************************************
'下選択肢 4(3) → 1 (0):ON,他OFF
'*****************************************************************************************************
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 0,(X,300),0,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
'****************************************************************************************************
'4.トップ画面に戻るを選択 → 　1.数秘術占いを選択
'*****************************************************************************************************
end select
endif
'*****************************************************************************************************
'chr$(31):カーソル　上  or  y = -1 ジョイパッド　上
'*****************************************************************************************************
if ((y = -1) or (key$ = chr$(30))) then
select case No
'*****************************************************************************************************
'〇.ここからカーソルを上にやる処理。
'・1.スタート:1.数秘術占い
'・case 0・1.数秘術占い → 4.トップ画面に戻るを選択 , case 0: No:1 → No:3　
'・case 1・2.バーズアイグリット →1.数秘術占い　,case 1: No:2→ No:1
'・case 2・3.相性占い → 2.バーズアイグリット,case 2: No:2 → No:1
'・case 3・4.トップ画面に戻る → 3.相性占い,case 3: No:3 → No:2
'*****************************************************************************************************
case 0:
'*****************************************************************************************************
''・case 0・1.数秘術占い → 4.トップ画面に戻るを選択
'********************************************************************************************************
'上:選択肢 1 → 4 :ON 他OFF　1.数秘術占いを選択　(0)  →　　4.トップ画面に戻る　(3):済
'*********************************************************************************************************
No=3:sp_on 3,1:sp_on 1,0:sp_on 2,0:sp_on 0,0:sp_put 3,(X,Y+300),3,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
'*********************************************************************************************************
case 1:
'********************************************************************************************************
'・case 1.数秘術占い → ,case 1  No:1→No: 0
'********************************************************************************************************
'上:選択肢 4 → 3:ON,他OFF　 4.トップ画面に戻る(3)　→  3.相性占い(2)
'********************************************************************************************************
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 0,(X,Y),0,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
'********************************************************************************************************
case 2:
'*********************************************************************************************************
'・case 2・2.バーズアイグリット → 1.数秘術占い ,case 2: No:2 → No:1
'*********************************************************************************************************
'上:選択肢:3 → 2:ON ,他OFF 3.相性占い(2) → 2.バーズアイグリット (1)
'*********************************************************************************************************
No=1:sp_on 1,1:sp_on 0,0:sp_on 3,0:sp_on 2,0:sp_put 1,(X,Y+100),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "2.バーズアイグリットを選択":goto Kabara_TopScreen2:
'**********************************************************************************************************
case 3:
'**********************************************************************************************************
'・case 3・4.バーズアイグリット → 3.相性占い,case 3: No:3 →　No: 2
'**********************************************************************************************************
'上:選択肢 2 → 1 ON 他OFF　2.バーズアイグリット(3)　→　1.相性占い  (2）
'**********************************************************************************************************
No=2:sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(X,Y+200),2,0:beep:pause 200:locate 1,15:print "                                       ":locate 1,15:print "3.相性占いを選択":goto Kabara_TopScreen2:
'**********************************************************************************************************
end select
endif
'******************************************************************************************************
...
'********************************************************************************************************
'********************************************************************************************************
'決定ボタン:Enterキー　or ジョイパッド 右
'********************************************************************************************************
if ((bg = 2) or (key$ = chr$(13))) then
select case No
'**************************************************************************
'3.相性占い
'case 0:選択肢　1 ,1.数秘術占い
'***************************************************************************
case 0:
'1.数秘術占い
...
'case 2:選択肢　3, 3.相性占い
'***************************************************************************
sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,0:pause 200:goto Kabara_Aisyou_Top:
'**************************************************************************
'3.相性占い
'case 2:選択肢　3, 3.相性占い
'***************************************************************************
...
if (bg2 = 2) then
'***************************************************************************
'1.再生中の音を停めて、200msec CPU 停止
'2.音声を再生
'"Kabara_TopScreen2"リストに飛ぶ
'****************************************************************************
play "":pause 200
...
'***************************************************************************************************
'Birds Eye入力　アルファベットで姓と名を入力する
'姓入力　Input_name1_Birdseye:
' ↓
'名入力　Inputname2:
'　↓
'計算
...
'Birdseye　結果表示
'****************************************************************************************************
cls 3:init "kb:2":play "":font FONT
...
'****************************************************************************************************
'****************************************************************************************************
'結果表示領域  バーズアイグリット 結果表示
'****************************************************************************************************
Result_Birtheye1:
cls 3:init"kb:4":play "": '音を止める
bg=0:key$="":bg2=0
'****************************************************************************************************
'1280x800　ここから 画像設定　1280x800 MB1001
'****************************************************************************************************
if ((size(0) <= 1280) and (size(1) <= 800)) then
gload Gazo$ + Gazo_WXGA$ + "Result_Birtheye1_907x640_20240223.png",0,0,0
'****************************************************************************************************
'1280x800　ここまで　画像設定 1280x800 MB1001
'****************************************************************************************************
'***************************************************************************************************
'Project point
'***************************************************************************************************
color rgb(0,0,0)
'1の表示
locate 4,18:print buffer(0)
'2の表示
locate 4,12:print buffer(1)
'3の表示
locate 4,7:print buffer(2)
'4の表示
locate 12,18:print buffer(3)
'5の表示
locate 12,12:print buffer(4)
'6の表示
locate 12,7:print buffer(5)
'7の表示
locate 19,18:print buffer(6)
'8の表示
locate 19,12:print buffer(7)
'9の表示
locate 19,7:print buffer(8)
color rgb(0,0,0)
locate 6,4:print ucase$(name1$ + name2$)
''****************************************************************************************************
'Project point ここから
'****************************************************************************************************
else
'if ((size(0)<=1920) and (size(1)<=1280)) then
'****************************************************************************************************
'1920x1280　ここから　画像設定 1920x1280
'****************************************************************************************************
gload Gazo$ + "Result_Birtheye1_20230630.png",0,0,0
gload Gazo$ + "downscreen.png",0,0,800
'****************************************************************************************************
'1920x1280　ここまで　画像設定 1920x1280
'****************************************************************************************************
'***************************************************************************************************
'Project point
'***************************************************************************************************
...
'****************************************************************************************************
color rgb(0,0,0)
locate 6,3:print ucase$(name1$ + name2$)
locate 0,15
color rgb(0,0,0)
print "左の丸:トップ画面、右の丸:メニュー"
endif
'****************************************************************************************************
'1920x1280　ここまで　画像設定 1280x800 MB1001
'1280x800 & 1920x1280 共通部分
'****************************************************************************************************
play Voice$ + "Result_Birdseyegrid_20231120.mp3"
'****************************************************************************************************
'1280x800　ここから　1280x800 & 1920x1280 共通部分
'バーズアイグリットが表示されないので
'いったんコメントアウト
'ここから
'if ((size(0) <= 1280) and (size(1) <= 800)) then
...
'name を大文字に変換
'if ((size(0) <= 1280) and (size(1) <= 800)) then
'color rgb(0,0,0):font FONT
'locate 5,3
'print ucase$(name1$ + name2$)
'else
'name を大文字に変換
...
'font FONT
'locate 0,20
'print "左の丸:メイン画面,右の丸：メニューを開く"
'else
'font FONT
'color rgb(0,0,0)
'locate 0,15
'print "右の丸:次へ,左の丸：もう一度診断 "
'endif
'endif
while ((bg <> 2) and (key$ <> chr$(13)) and (bg2 <> 2))
'Enterと決定ボタン
...
select case No
case 0:
sp_on 0,0:sp_on 1,0:sp_on 2,0:No=0: 'goto Input_Seireki: goto Kabara_TopScreen:
goto Kabara_Aisyou_Top:
'case 1:
...
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:pause 200:Gosub Kabara_Aisyou_Top_Recheck
:locate 1,15:print "                                                                               ":locate 1,15:print "2. Select business compatibility fortune-telling":goto Kabara_Aishou_Top2:
'Option change 2 - 3
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:Gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                       ":locate 1,15:print "3. Select return to the top screen":locate 1,16:goto Kabara_Aishou_Top2:
'Release time case 2 comment release
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200::Gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                      ":locate 1,15:print "1. Select compatibility fortune-telling of two men and women":goto Kabara_Aishou_Top2:
case else:
...
select case No
case 0:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200::Gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                       ":locate 1,15:print " :3. Return to the top screen" :goto Kabara_Aishou_Top2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200::Gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print"                                       ":locate 1,15:print " :1. Compatibility fortune-telling...." :goto Kabara_Aishou_Top2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:pause 200::Gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                      ":locate 1,15:print " :2. Business compatibility fortune-telling":goto Kabara_Aishou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
...
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:sp_put 1,(X,Y+150),1,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                                                               ":color rgb(0,0,0):locate 1,15:print "2.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
'選択肢　2 - 3に変更
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_put 2,(X,Y+300),2,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                       ":color rgb(0,0,0):locate 1,15:print "3.トップ画面に戻るを選択":goto Kabara_Aishou_Top2:
'リリース時 case 2コメント解除
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_put 0,(X,Y),0,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                      ":color rgb(0,0,0):locate 1,15:print "1.男女2人の相性占いを選択":goto Kabara_Aishou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
...
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_put 0,(X,Y),0,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print"                                       ":color rgb(0,0,0):locate 1,15:print "1.男女2人の相性占いを選択":goto Kabara_Aishou_Top2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_put 1,(X,Y+150),1,0:beep:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,15:print "                                      ":color rgb(0,0,0):locate 1,15:print "2.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
end select
endif
endif
'**************************************************************************************************************************
...
cls 3:sp_on 0,0:sp_on 1,0:sp_on 2,0:goto Aisyou_Top:
'2ビジネスの相性
case 1:
...
'****************************************************************************************
case 0:
No = 1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_put 1,(X,Y+150),1,0:beep:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,15:print "                                                                               ":locate 1,15:color rgb(0,0,0):print "2.男女の相性占いを選択":goto Danjyo_Aisyou_Top2:
'選択肢　2(1) - 3(2)に変更
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_put 2,(X,Y+300),2,0:beep:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,15:print "                                       ":locate 1,15:color rgb(0,0,0):print "3.トップ画面に戻るを選択":goto Danjyo_Aisyou_Top2:
'リリース時 case 2コメント解除
'選択肢 3(2)-1(0)
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_put 0,(X,Y),0,0:beep:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,15:print "                                      ":locate 1,15:color rgb(0,0,0):print "1.自分と異性の相性占い(未実装)を選択":goto Danjyo_Aisyou_Top2:
case else:
goto Danjyo_Aisyou_Top2:
end select
endif
...
'*********************************************************************************
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_put 0,(X,Y),0,0:beep:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,15:print"                                       ":locate 1,15:color rgb(0,0,0):print "1.自分と異性の相性占いを選択":goto Danjyo_Aisyou_Top2:
'*********************************************************************************
'選択肢　3(2) - 2(1)
'*********************************************************************************
case 2:
...
goto Danjyo_Aisyou_Input_Name_male:
'0.男女の相性　トップ画面　ここまで
'*****************************************************************************************************
'1.男女の相性 ここから
'1-1.男性の名前を入力
...
cls 3:init "kb:2"
if (size(0)<=1280 and size(1)<=800) then
gload Gazo$ + Gazo_WXGA$ + "InputNameAisyou.png",0,0,0
else
gload Gazo$ + Gazo_WXGA$ + "InputNameAisyou.png",0,0,0
gload Gazo$ + "downscreen.png",0,0,800
endif
...
'WUXG(1920x1200)の時ここから
'****************************************************************************************************
play "":color rgb(255,0,0):male_name$ = "":font FONT
locate 0,0
print "男性の名前入力"
color rgb(255,255,255):
locate 0,2
print "男性の相性を求めます。男性の名前を"
locate 0,4
print "入れてください"
locate 0,5:color rgb(0,0,255)
Input "男性の名前:",male_name$
goto Danjyo_Aisyou_Input_Born_Year:
'****************************************************************************************************
'男性の誕生日入力に飛ぶ
'****************************************************************************************************
'****************************************************************************************************
...
print ":Ok"
'******************************************************************************************************
'選択肢 OK(ON) を選択,それ以外 OFF
'*******************************************************************************************************
'N=1:4,No=2:5,No=3:6
sp_on 4,0: sp_on 7,0:sp_on 10,0
'No=4:7,No=5:8,No=6:9
sp_on 5,0:sp_on 8,0:sp_on 11,0
'No=7:10,No=8:11,No=9:12
sp_on 6,0:sp_on 9,0:sp_on 12,0
'No=0(13),OK Button:-1(14)
sp_on 13,0:sp_on 14,1:No=-1
'-------------------------------------------------------------------------------------
...
'6ボタンから ９に移動
'****************************************************************************************************************************
No=9:sp_on 11,0:sp_on 10,1:beep
pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
'*****************************************************************************************************************************
'6ボタンから ９に移動　ここまで
'9で上を押して何もしない（下から上)
...
'*****************************************************************************************************************************
No=9
beep:pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
'****************************************************************************************************************************
'9で上を押しても何もしない　ここまで
'上　 0ボタンから2ボタン
'sp_on 6,1:1
...
pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 4:
No=4:beep:pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 9:
No=8:sp_on 7,1:sp_on 10,0:beep
pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 8:
...
pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 7:
No=7:beep:pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
end select
endif
'**************************************************************************
'右  十字キー　右　or カーソル　右
...
pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 8:
No=9:sp_on 7,0:sp_on 10,1:beep
pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 9:
beep:pause 200:goto Danjyo_Aisyou_Input_Male_Born_Year2:
case 6:
...
gosub Selection_ALL_OFF:
pause 200:
goto Danjyo_Aisyou_Input_Male_Born_Month:
case else:
end select
'*************************************
'1.Okボタンを決定ボタンで押したときの処理
'いきなりOKを押すと、相性トップ画面に戻る
'**************************************
'goto Aisyou_Top:
case else:
'Okボタン以外が押されたとき
...
select case count
case 1:
buf_year = No:buf_year$ = "":buf_year$ = str$(No) + "***"
case else:
if (count <= 2 and count <= 4) then
buf_year = buf_year * 10 + No:
select case count
case 2:
buf_year$=str$(buf_year * 10 + No) + "**"
case 3:
buf_year$=str$(buf_year * 10 + No) + "*"
case 4:
buf_year$=str$(buf_year * 10 + No)
...
'else
'********************************************
'2.OK 以外を決定ボタンで押したときの処理
'********************************************
'********************************************
'生まれた年代の一桁目に誕生日の番号Noを代入。
'********************************************
'Okボタンを押したとき
...
'3~9
'****************************************************************************************************
'if (2 < No and No <= 9) then
'ui_msg "数字が範囲外になります。数字を入れ直してください"
'endif
'endif
'buf_year$="":buf_year=0
'locate 1,3
...
'print "count=";count
'OKを押したら生まれた月に飛ぶ
'gosub Selection_ALL_OFF:pause 200
'goto Danjyo_Aisyou_Input_Male_Born_Month:
'else
'何もしない処理
'count = count + 1
...
'************************************************************************
'ジョイパッドの左ボタン　キャンセルを押すと　相性のトップ画面に飛ぶ
'************************************************************************
if (bg2 = 2) then
select case count2
case 0:
...
'Init"kb:4"
'音声ファイル再生 2024.05.24
'男女の相性占いです。男性の生まれた月を入力してください
play Voice$ + "Input_Born_Month_Danjyo_20240524.mp3"
'****************************************************************************************************
'WUXG(1920x1200)の時ここから
'****************************************************************************************************
font FONT
...
' 誕生日を単数変換して
' 相性票を読み込んで比較する。
'ラベル:Danjyo_Aisyou_Complate:
'********************************************************
Danjyo_Aisyou_Complate:
cls 3:print "相性計算　OK"
'*********************************************************
'male  Kabara: Kabara_male_Number = Kabara_Num(buf_male_year,buf_male_month,buf_male_day)
'female Kabara : Kabara_female_Number = Kabara_Num(buf_female_year,buf_female_buf_female_day)
'**********************************************************
'**********************************************************
'男性の名前を入力する　ここから
'**********************************************************
buffer_Kabara_male_name$ = male_name$
'**********************************************************
'男性の名前を入力する　ここまで
'**********************************************************
'**********************************************************
'女性の名前を入力する　ここから
'**********************************************************
buffer_Kabara_female_name$ = female_name$
'**********************************************************
'女性の名前を入力する　ここまで
'**********************************************************
'***********************************************************
'男性の数秘ナンバーを求める　ここから
'***********************************************************
Kabara_male_Number = Kabara_Num(buf_male_year,buf_male_month,buf_male_day)
'************************************************************
'男性の数秘ナンバーを求める　ここまで
'************************************************************
'************************************************************
'女性の数秘ナンバーを求める　ここから
'*************************************************************
Kabara_female_Number = Kabara_Num(buf_female_year,buf_female_month,buf_female_day)
'*************************************************************
'女性の数秘ナンバーを求める　ここまで
'*************************************************************
'男女の相性を求める
...
'自作関数 ここから
BirdsEyeGrid_Entry:
cls 3:init "kb:4":key$="":bg=0:flag=0:bg2=0:play"":n=0:ncount=0
'****************************************************************************************************
...
'1280x800の時　ここから
'*****************************************************************************************************
locate 1,3:print "登録件数は";str$(ncount);"件です"
...
'*****************************************************************************************************
locate 1,2:print "登録件数は";str$(ncount);"件です"
locate 1,4:print "左の丸：メイン画面へ行く,右の丸:リスト"
'*****************************************************************************************************
...
color rgb(255,255,255)
locate 6,4
buf1$ = buffer_List$(0,j):buf2$ = buffer_List$(1,j)
print buffer_List$(0,j) + spc(1) +  buffer_List$(1,j)
'1の文字データー
locate 5,18
buf3$=buffer_List$(2,j)
print val(buffer_List$(2,j))
'2の文字データー
locate 5,12
print buffer_List$(3,j)
'3の文字データー
locate 5,7
print buffer_List$(4,j)
'4の文字データー
locate 14,18
print buffer_List$(5,j)
'5の文字データー
locate 14,12
PRINT buffer_List$(6,j)
'6の文字データー
locate 14,7
print buffer_List$(7,j)
'7の文字データー
locate 20,18
print buffer_List$(8,j)
'8の文字データー
locate 20,12
print buffer_List$(9,j)
'9の文字データー
locate 20,7
print buffer_List$(10,j)
color rgb(0,0,0)
locate 1,19:print "左の丸:メイン画面,右の丸：次へ"
else
font FONT
color rgb(255,255,255)
locate 5,3
...
print buffer_List$(0,j) + spc(1) +  buffer_List$(1,j)
'1の文字データー
locate 3,14:buf3$=buffer_List$(2,j)
print val(buffer_List$(2,j))
'2の文字データー
locate 4,9
print buffer_List$(3,j)
...
print buffer_List$(10,j)
color rgb(0,0,0)
locate 1,17:print "左の丸:メイン画面,右の丸：次へ"
endif
if (bg = 2 or key$ = chr$(13)) then
j = (j + 1) Mod ncount
goto show_ListData:
...
'相性占い　トップ画面
'*****************************************************************
Danjyo_Aisyou_TopScreen_Recheck:
font FONT
color rgb(255,255,255):
'locate 0,3
'print "                    "
