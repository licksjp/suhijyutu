...
case 2:
'******************************************************************************************************
'下 選択肢 3(2) → 4 (3):ON ,他 OFF　
'******************************************************************************************************
No=3:sp_on 3,1:sp_on 1,0:sp_on 2,0:sp_on 0,0:sp_put 3,(5,600),3,0:beep:pause 200:locate 1,15:print "                                    ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
'4.トップ画面に戻る → 1.数秘術の相性占いを選択
case 3:
'******************************************************************************************************
'下選択肢 4(3) → 1 (0):ON,他OFF
'******************************************************************************************************
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 0,(5,300),0,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
'1.数秘術占いを選択 → 2.バーズアイグリット　
case 0:
'******************************************************************************************************
'下 選択肢 1(0) → 2  ON (1)他　OFF
'******************************************************************************************************
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(5,400),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
'2.バーズアイグッリット → 3.相性占い
case 1:
'******************************************************************************************************
'下 選択肢:2(1) → 3 (2) :ON (2) 他 OFF
'******************************************************************************************************
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(5,500),2,0:beep:pause 200:locate 1,15:print "                                              ":locate 1,15:print "3.相性占いを選択":goto Kabara_TopScreen2:
end select
endif
'*********************************************************************************************************
'chr$(31):カーソル　上  or  y = -1ジョイパッド　上
'*********************************************************************************************************
if ((y = -1) or (key$ = chr$(30))) then
select case No
case 2:
'*********************************************************************************************************
'上:選択肢:3 → 4:ON ,他OFF 3.相性占い(2) → 　4.トップ画面に戻る (3)
'*********************************************************************************************************
No=3:sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,1:sp_put 3,(X,Y+300),3,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
case 1:
'********************************************************************************************************
'上:選択肢 2 → 1:ON,他OFF　2.バーズアイグリット(1)　→  1.数秘術占いを選択(0)
'********************************************************************************************************
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(X,Y),0,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 0:
'*********************************************************************************************************
'上:選択肢 2 → 1 ON 他OFF　　3.相性占い　(2)→　　2.バーズアイグリット　(1)
'*********************************************************************************************************
...
case 3:
'**********************************************************************************************************
'上:選択肢 3 → 2 ON 他OFF　4.トップ画面に戻る(3)　→　3. 相性占いを選択  (2)
'**********************************************************************************************************
