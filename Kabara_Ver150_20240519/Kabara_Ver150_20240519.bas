...
'******************************************************************************************************
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y + 100),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
'1.数秘術占い → 2.バーズアイグッリット
case 1:
'******************************************************************************************************
'下 選択肢:2(1):2.バーズアイグッリット → 3 (2):3.相性占い :ON (2) 他OFF (0,1,3):〇
'******************************************************************************************************
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(X,Y + 200),2,0:beep:pause 200:locate 1,15:print "                                              ":locate 1,15:print "3.相性占いを選択":goto Kabara_TopScreen2:
'2.バーズアイグッリット →　3.相性占い 
case 2:
'******************************************************************************************************
...
'・case 1・2.トップ画面に戻るを選択 →3.相性占い　,case 1: No:3 → No:2
'・case 2・3.相性占い → 2.バーズアイグリット ,case 2: No:2 → No:1
'・case 3・4.バーズアイグリット → 1.数秘術占い ,case 3: No:1 → No:0
case 0:
''・case 0・1.数秘術占い → 4.トップ画面に戻るを選択
'*********************************************************************************************************
'上:選択肢 1 → 4 :ON 他OFF　1.数秘術占いを選択　(0)  →　　4.トップ画面に戻る　(3):済
'*********************************************************************************************************
No=3:sp_on 3,1:sp_on 3,0:sp_on 2,0:sp_on 0,0:sp_put 3,(X,Y+300),3,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
case 3:
'・case 3・4.バーズアイグリット → 1.数秘術占い ,case 3: No:1 → No:0
'********************************************************************************************************
'上:選択肢 4 → 3:ON,他OFF　 4.トップ画面に戻る(3)　→  3.相性占い(2) 
'********************************************************************************************************
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 2,(X,Y),2,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 2:
'・case 2・3.相性占い → 2.バーズアイグリット ,case 2: No:2 → No:1
'*********************************************************************************************************
'上:選択肢:3 → 2:ON ,他OFF 3.相性占い(2) → 2.バーズアイグリット (1)
'*********************************************************************************************************
No=1:sp_on 1,1:sp_on 0,1:sp_on 3,0:sp_on 2,0:sp_put 1,(X,Y+100),1,0:beep:pause 200:locate 1,15:print "                                      ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
case 3:
'・case 3・4.バーズアイグリット → 1.数秘術占い ,case 3: No:1 → No:0
'**********************************************************************************************************
'上:選択肢 2 → 1 ON 他OFF　2.バーズアイグリット(1)　→　1.数秘術占い  (0)
'**********************************************************************************************************
No=0:sp_on 0,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 0,(X,Y),0,0:beep:pause 200:locate 1,15:print "                                       ":locate 1,15:print "3.相性占いを選択":goto Kabara_TopScreen2:
end select
endif
'******************************************************************************************************
'日本語 ここまで
...
sp_on 0,1:sp_on 1,0:sp_on 2,0
color rgb(0,0,0)
locate 1,19:print "1.男女2人の相性占いを選択"
'****************************************************************************************************
'WUXG(1920x1200)の時ここまで
'****************************************************************************************************
endif
...
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,19:print "                                                                               ":color rgb(0,0,0):locate 1,19:print "2.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
'選択肢　2 - 3に変更
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,19:print "                                       ":color rgb(0,0,0):locate 1,19:print "3.トップ画面に戻るを選択":goto Kabara_Aishou_Top2:
'リリース時 case 2コメント解除
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,19:print "                                      ":color rgb(0,0,0):locate 1,19:print "1.男女2人の相性占いを選択":goto Kabara_Aishou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
...
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,19:print"                                       ":color rgb(0,0,0):locate 1,19:print "1.男女2人の相性占いを選択":goto Kabara_Aishou_Top2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:pause 200:gosub Kabara_Aisyou_Top_Recheck:locate 1,19:print "                                      ":color rgb(0,0,0):locate 1,19:print "2.ビジネスの相性占いを選択":goto Kabara_Aishou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
...
'**************************************************************************************************:
locate 1,19:print "1.自分と異性の相性(未実装)を選択"
'****************************************************************************************************
'WUXG(1920x1200)の時ここまで
'****************************************************************************************************
'***************************************************************************************************
...
'ok
case 0:
No = 1:sp_on 1,1:sp_on 2,0:sp_on 0,0:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                                                               ":locate 1,19:color rgb(0,0,0):print "2.男女2人の相性を選択":goto Danjyo_Aisyou_Top2:
'選択肢　2 - 3に変更
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                       ":locate 1,19:color rgb(0,0,0):print "3.トップ画面に戻るを選択":goto Danjyo_Aisyou_Top2:
'リリース時 case 2コメント解除
case 2:
No = 0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                      ":locate 1,19:color rgb(0,0,0):print "1.自分と異性の相性占い(未実装)を選択":goto Danjyo_Aisyou_Top2:
case else:
goto Danjyo_Aisyou_Top2:
end select
endif
...
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                       ":locate 1,19:color rgb(0,0,0):print "3.トップ画面に戻るを選択":goto Danjyo_Aisyou_Top2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print"                                       ":locate 1,19:color rgb(0,0,0):print "1.自分と異性の相性占いを選択":goto Danjyo_Aisyou_Top2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:pause 200:gosub Danjyo_Aisyou_TopScreen_Recheck::locate 1,19:print "                                      ":locate 1,19:color rgb(0,0,0):print "2.男女2人の相性占いを選択":goto Danjyo_Aisyou_Top2:
case else:
goto Kabara_Aishou_Top2:
end select
endif
