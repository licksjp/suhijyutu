...
color rgb(255,255,255)
locate 6,3
buf1$ = buffer_List$(0,0):buf2$ = buffer_List$(1,0)
print buffer_List$(0,0) + buffer_List$(1,0)
'1の文字データー
locate 4,14
buf3$=buffer_List$(2,0)
print val(buffer_List$(2,0))
'2の文字データー
locate 4,9
print buffer_List$(3,0)
'3の文字データー
locate 4,5
print buffer_List$(4,0)
'4の文字データー
locate 11,14
print buffer_List$(5,0)
'5の文字データー
locate 11,9
PRINT buffer_List$(6,0)
'6の文字データー
locate 11,5
print buffer_List$(7,0)
'7の文字データー
locate 16,14
print buffer_List$(8,0)
'8の文字データー
locate 16,9
print buffer_List$(9,0)
'9の文字データー
locate 16,5
print buffer_List$(10,0)
color rgb(255,255,255)
locate 1,15:print "左の丸:メイン画面,右の丸：次へ"
'if (bg = 2 or key$ = chr$(13)) then
'j = j + 1
goto show_ListData:
endif
