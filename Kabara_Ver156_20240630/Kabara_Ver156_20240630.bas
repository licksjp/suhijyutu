...
beep:pause 200:goto Input_Born_Month2:
case 4:
No=5:sp_on 8,1:sp_on 10,0:beep
pause 200:goto Input_Born_Month2:
case 5:
No=6:sp_on 11,1:sp_on 8,0:beep
pause 200:goto Input_Born_Month2:
case 7:
No=8:sp_on 7,1:sp_on 11,0:beep
pause 200:goto Input_Born_Month2:
case 8:
No=9:sp_on 12,1:sp_on 7,0:beep
pause 200:goto Input_Born_Month2:
case 9:
beep:pause 200:goto Input_Born_Month2:
case 6:
...
select case No
case 2:
No=3:sp_on 3,1:sp_on 1,0:sp_on 2,0:sp_on 0,0:sp_put 3,(X,Y+320),3,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,15:print "                                    ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
case 3:
No=0:sp_on 0,1:sp_on 2,0:sp_on 1,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0): locate 1,15:print"                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 0:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),1,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,15:print "                                      ":locate 1,15:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
case 1:
No=2:sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,15:print "                                              ":locate 1,15:print"3.相性占いを選択":goto Kabara_TopScreen2:
end select
endif
...
select case No
case 0:
No=3:sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,1:sp_put 3,(X,Y+320),3,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,15:print "                                      ":locate 1,15:print "4.トップ画面に戻るを選択":goto Kabara_TopScreen2:
case 1:
No=0:sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(X,Y+20),0,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,15:print "                                      ":locate 1,15:print "1.数秘術占いを選択":goto Kabara_TopScreen2:
case 2:
No=1:sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(X,Y+120),1,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,18:print "                                      ":locate 1,15:print "2.バーズアイグリッドを選択":goto Kabara_TopScreen2:
case 3:
No=2:sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(X,Y+220),2,0:beep:pause 200:gosub Kabara_TopScreen_Recheck::color rgb(0,0,0):locate 1,15:print "                                       ":locate 1,15:print "3.相性占いを選択":goto Kabara_TopScreen2:
end select
endif
'*****************************************************************************************************
